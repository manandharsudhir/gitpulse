...
abstract class $ApiResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? success, dynamic payload});
}
...
class _$ApiResponseImpl implements _ApiResponse {
  const _$ApiResponseImpl({this.success, this.payload});
  ...
  @override
  String toString() {
    return 'ApiResponse(success: $success, payload: $payload)';
  }
...
abstract class _ApiResponse implements ApiResponse {
  const factory _ApiResponse({final bool? success, final dynamic payload}) =
      _$ApiResponseImpl;
